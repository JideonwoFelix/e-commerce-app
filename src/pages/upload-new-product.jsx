        ...
        <div className='w-3/5 mx-auto mt-10'>
            ...
            <form onSubmit={handleSubmit}>
                <div className="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        <label for="first_name" className="block mb-2 text-sm font-medium text-gray-900 xdark:text-white">Product Name</label>
                    ...
                    <div>
                        <label for="last_name" className="block mb-2 text-sm font-medium text-gray-900 xdark:text-white">Product Price</label>
                    ...
                    <div className='col-span-2'>
                        <label for="company" className="block mb-2 text-sm font-medium text-gray-900 xdark:text-white">Product Category</label>
                        <select type="text" id="company" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea porro placeat necessitatibus tempore, modi expedita, corporis laborum possimus distinctio qui sapiente aliquam ut numquam optio? Illo odit minima natus nulla!" required rows='6' value={productDesc} onChange={handleProductDescChange}>
                            <option value="" disabled selected>Select a  Product Cartegory</option>
                            {
                    ...
                    <div className='col-span-2'>
                        <label for="company" className="block mb-2 text-sm font-medium text-gray-900 xdark:text-white">Product Description</label>
